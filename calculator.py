...
btn_equal = Button(mw, text='=', padx=36, pady=42, font=('Arial', 14), command=equal)

# showing widgets

btn_equal.grid(row=5, column=2, rowspan=2, pady=2, padx=2)

btn_add.grid(row=6, column=1, pady=2, padx=2)
btn_sub.grid(row=6, column=0, pady=2, padx=2)
btn_mul.grid(row=5, column=1, pady=2, padx=2)
btn_div.grid(row=5, column=0, pady=2, padx=2)

btn_clear.grid(row=4, column=1, columnspan=2, pady=2, padx=2)

btn_0.grid(row=4, column=0, pady=2, padx=2)

btn_1.grid(row=3, column=0, pady=2, padx=2)
btn_2.grid(row=3, column=1, pady=2, padx=2)
btn_3.grid(row=3, column=2, pady=2, padx=2)

btn_4.grid(row=2, column=0, pady=2, padx=2)
btn_5.grid(row=2, column=1, pady=2, padx=2)
btn_6.grid(row=2, column=2, pady=2, padx=2)

btn_7.grid(row=1, column=0, pady=2, padx=2)
btn_8.grid(row=1, column=1, pady=2, padx=2)

btn_9.grid(row=1, column=2, pady=2, padx=2)
